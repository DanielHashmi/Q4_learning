...
if __name__ == "__main__":
    mcp_server.run(transport="streamable-http") # (Streamable HTTP) Server runs as a standalone HTTP server, not a subprocess, client connects over HTTP instead of stdio